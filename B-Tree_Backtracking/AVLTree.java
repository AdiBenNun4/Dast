...
public class AVLTree implements Iterable<Integer> {
    ...
    protected class Node {
    	...
    	public int height = 0;
    	public int value;
    	public int size; //added field for selected and rank
    ...
    protected Node root;
    public ArrayDeque backtrack; //added field for backtracking
	...
	public void insert(int value) {
    	...
    	backtrack.push(new Boolean(true)); //adding a partition (type Boolean)
    }
	...
	protected Node insertNode(Node node, int value) {
        ...
        if (node == null) {
        	...
        	backtrack.push(insertedNode); //adding the node that was entered
            return insertedNode;
        }
        ...
        if (balance > 1) {
        	...
        	backtrack.push(node); //adding the node that has been rotated to the deque
            
        	if (value > node.left.value) {
            	
            	backtrack.push(node.left);//adding the node that has been rotated to the deque
        	...
        	if (value < node.right.value) {
            	...
            	backtrack.push(node.right);//adding the node that has been rotated to the deque
    ...
    protected Node rotateRight(Node y) {
        ...
        y.updateHeight();//updating size of sub-tree
        y.updateSize();
        x.updateHeight();//updating size of sub-tree
        x.updateSize();
    ...
    protected Node rotateLeft(Node x) {
        ...
        x.updateHeight();
        x.updateSize();//updating size of sub-tree
        y.updateHeight();
        y.updateSize();//updating size of sub-tree
